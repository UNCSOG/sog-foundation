<?php
/**
 * Simple text header core template - Vertical w/ Line Alternate (site name and description/tag field shows above the school name).
 *
...
?>
<div class="sog-rebrand__header-core sog-rebrand__header-core--simple-text sog-rebrand__header-core--simple-text-vertical-line-alternate">
