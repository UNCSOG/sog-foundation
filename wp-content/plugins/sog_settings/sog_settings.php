...
function sql_scripts() {
    ...
    wp_enqueue_script( 'sog_settings_sql_js',  plugin_dir_url( __FILE__ ) . 'inc/js/js.js',array('jquery'),time() );                      
	wp_localize_script('sog_settings_sql_js', 'sog_settings_vars', array('plugin_path' => plugin_dir_url(__FILE__),"siteurl"=>get_option('siteurl')));
    wp_enqueue_style('sog_settings_bootstrap_css', 'https://cdn.jsdelivr.net/npm/bootstrap@5.1.3/dist/css/bootstrap.min.css');
    wp_enqueue_script( 'sog_settings_bootstrap_js','https://cdn.jsdelivr.net/npm/bootstrap@5.1.3/dist/js/bootstrap.min.js', array( 'jquery' ),'',true );
