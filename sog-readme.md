...
## To fix merge conflicts in a site using this upstream (use the following on any sites that are using this upstream)
...
```bash
    ...
    git commit -m "Merging sog-foundation updates."
```
