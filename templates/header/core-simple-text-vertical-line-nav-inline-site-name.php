<?php
/**
 * Simple text header core template - Vertical w/ Line (has the navigation desktop and mobile, school name and the site name). Has a vertical line separating the school name and site name, and the navigation is inline with the site name.
 *
...
<div class="sog-rebrand__header-core sog-rebrand__header-core--simple-text sog-rebrand__header-core--simple-text-vertical-nav-inline-site-name">
	<div class="sog-rebrand__inner">
		<div class="sog-rebrand__header-shell">
			...
			<div class="sog-rebrand__brand-cluster sog-rebrand__site-name-nav-cluster">
				<div class="sog-rebrand__brand-cluster sog-rebrand__site-name-cluster">
					<div class="sog-rebrand__brand-cluster">
						<?php if ( !empty($settings['header_text_links_enabled']) ) : ?>
							<?php if( $logo_url  ) : ?>
								<a class="sog-rebrand__brand-link" href="<?php echo esc_url( $logo_url ); ?>">
									<span class="sog-rebrand__brand-title site-name" style="<?php echo esc_attr( $site_name_style ); ?>">
										<?php echo esc_html( $site_name ); ?>
									</span>
								</a>
							<?php endif; ?>
						<?php else : ?>
							<p class="sog-rebrand__brand-title site-name" style="<?php echo esc_attr( $site_name_style ); ?>">
								<?php echo esc_html( $site_name ); ?>
							</p>
						<?php endif; ?>
					</div>
					...
					<?php if ( ! empty( $site_description ) ) : ?>
						<div class="sog-rebrand__brand-cluster">
							<p class="sog-rebrand__brand-title site-tagline site-description" style="<?php echo esc_attr( $site_description_style ); ?>">
				...
				<?php if ( $header_main_menu || $show_mobile_toggle ) : ?>
					<div class="sog-rebrand__brand-cluster sog-rebrand__navigation-cluster" style="<?php echo $navigation_styles; ?>">
						...
						<?php if ( $show_mobile_toggle ) : ?>
							<button class="sog-rebrand__menu-toggle" type="button" aria-expanded="false" aria-controls="<?php echo esc_attr( $mobile_nav_id ); ?>" style="<?php echo $navigation_styles; ?>">
								<span class="sog-rebrand__menu-toggle-label">
									<?php echo esc_html__( 'Menu', 'sog-unc-rebrand' ); ?>
								</span>
