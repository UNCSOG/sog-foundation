<?php
/**
 * Simple text header core template - Vertical w/ Line Alternate (site name and school name field shows above the description/tag).
 *
...
?>
<div class="sog-rebrand__header-core sog-rebrand__header-core--simple-text sog-rebrand__header-core--simple-text-vertical-line-site-name-school-name-tagline">
	<div class="sog-rebrand__inner">
		<div class="sog-rebrand__header-shell">
			<div class="sog-rebrand__brand-cluster site-name-school-name-cluster">
