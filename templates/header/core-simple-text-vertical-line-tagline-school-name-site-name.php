<?php
/**
 * Simple text header core template - Vertical w/ Line Tagline, school, line, then site name (description/tagline and school name field shows above the site name).
 *
...
?>
<div class="sog-rebrand__header-core sog-rebrand__header-core--simple-text sog-rebrand__header-core--simple-text-vertical-line-tagline-school-name-site-name">
	<div class="sog-rebrand__inner">
		<div class="sog-rebrand__header-shell">
			<div class="sog-rebrand__brand-cluster site-description-school-name-cluster">
