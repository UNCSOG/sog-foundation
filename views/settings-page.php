...
if (!isset($unc_cookie_banner_exclude_pages)) {
    $unc_cookie_banner_exclude_pages = '';
}
?>
    ...
    <form method="post" action="" style="text-align: left;">
        ...
        <table class="form-table" style="text-align: left; padding:0;">
            <tbody>
                ...
                <tr style="text-align: left;">
                    <th scope="row" colspan="2" style="text-align: left; padding-bottom: 10px;">
                        <label for="unc_cookie_banner_exclude_pages" style="text-align: left; ">Exclude Website Pages</label>
                        <p class="description" style="margin-bottom: 0; text-align: left;">Comma-separated list of page IDs</p>
                    </th>
                </tr>

                <tr style="text-align: left;">
                    <td colspan="2" style="text-align: left; padding:0;">
                        <textarea name="unc_cookie_banner_exclude_pages" id="unc_cookie_banner_exclude_pages" rows="5" cols="75" style="text-align: left;"><?php echo esc_textarea($unc_cookie_banner_exclude_pages); ?></textarea>
                    </td>
                </tr>
